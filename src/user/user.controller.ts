...
import { Body, Controller, Delete, Get, Headers, HttpException, HttpStatus, Param, ParseIntPipe, Post, Query, Request, Res, Response, Session, } from '@nestjs/common';
import { UserService } from './service/user.service';
import { AppletLoginDto, LoginDto, UserDto, UserUpdateDto } from './dto/req-user.dto';
import { ApiOperation, ApiTags } from '@nestjs/swagger';
import { APIResponse } from 'src/request/response';
import { Public, PublicUser, ReqUser } from './user.decorator';
...
export class UserController {
  ...
  getUserInfo(
    ...
    return this.userService.findUser(id ? id : user.openId)
  }
  ...
  @Post('wxLogin')
  wxlogin(
    @Body() loginInfo: AppletLoginDto,
  ) {
    return this.authService.wxLogin(loginInfo);
  }
  ...
  collects(
    ...
    return this.userService.getUserCollectCard(body, user)
  }
  @ApiOperation({
    summary: '我购买的商品'
  })
  ...
  userCard(
    ...
    return this.userService.getUserCard(body, user)
  }
